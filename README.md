...
### [Project Page](http://tancik.com/nerf) | [Video](https://youtu.be/JuH79E8rdKc) | [Data](https://drive.google.com/drive/folders/128yBriW1IG_3NJ5Rp7APSTZsJqdJdfc1)
<br>
...
```python 
run_nerf.py --config config_fern.txt
...
```python 
run_nerf.py --config config_lego.txt
```
